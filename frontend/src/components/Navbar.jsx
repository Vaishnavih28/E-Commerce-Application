...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center py-5 font-medium'>
        ...
        <ul className='hidden sm:flex text-sm text-black gap-5'>
            <NavLink to='/' className='flex flex-col items-center gap-1' >
                <p>HOME</p>
                <hr className='w-2/4 border-none h-[1.5px] bg-purple-600 hidden ' />
            </NavLink>
        ...
        <div className='flex items-center gap-6'>
            ...
            }} src={assets.search_icon} className='cursor-pointer w-5' alt='' />
